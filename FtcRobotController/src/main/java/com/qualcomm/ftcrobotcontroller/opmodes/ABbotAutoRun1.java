 ...
 */
public class ABbotAutoRun1 extends PushBotTelemetrySensors{
...

    {
        ...
        switch (v_state)
        {
            ...
            case 0:
                ...
                //
                telemetry.addData ("07-1", "Drive State: " + v_state);
                if (have_drive_encoders_reset ())
                {
                    telemetry.addData ("08-1", "Drive State: " + v_state);
                    //
            ...
            /*case 2:
                ...
                if (have_drive_encoders_reset ())
                {
                    ...
                    //
                    drive_using_encoders (-1.0f, 1.0f, -2500, 2880);
            ...
            case 3:
                ...
                //
                if (drive_using_encoders (-1.0f, 1.0f, -2500, 2880))
                {
                    v_state++;
                }
                break;
     ...
     * state_2.  This implements a state machine for the oop method.
     */
