...
**/
...

    {
        ...
        float power_scale_factor = 0.5f;
        if (gamepad2.dpad_up){
            power_scale_factor = 1.0f;
        }
//
        // Manage the arm motor.
        //
        float l_left_arm_power = scale_motor_power((float)(gamepad2.left_stick_y - AveRightSpeed))* power_scale_factor;
