 ...
 */
public class ABbotHardware extends OpMode

{
...

    {
        ...
        try {
            v_motor_arm_extender = hardwareMap.dcMotor.get ("right_arm");
    ...
    double a_arm_extender ()
    {
        double l_return = 0.0;

        if (v_motor_left_arm != null)
        {
            l_return = v_motor_arm_extender.getPower ();
        }
    ...
    void m_arm_extender (double p_level)
    {
        if (v_motor_arm_extender != null)
        {
            v_motor_arm_extender.setPower (p_level);
        }
    ...
    private DcMotor v_motor_arm_extender;
